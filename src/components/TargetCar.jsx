...
export const TargetCar = ({ carsJson, style }) => {
  return (
    ...
    carsJson.map((car) => (
      <motion.div
        key={car._id}
        className={`bg-blue-50 h-[390px] ${style} flex flex-col justify-start items-center relative rounded-3xl overflow-hidden mb-3 hover:bg-blue-200 duration-1000 shadow-md shadow-blue-200`}
        initial={{ opacity: 0.5 }}
        animate={{ opacity: 1 }}
