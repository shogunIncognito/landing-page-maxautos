...
export default function NavBar () {
  return (
    // <div className='w-full h-24 bg-transparent max-lg:hidden lg:flex justify-center absolute'>
      <header className='bg-[#1DA1F2] max-[1920px]:h-[75px] min-[2560px]:h-24 shadow-xl lg:flex-col md:flex-row top-0 fixed duration-300 ease-in-out transition-all z-[60] p-4 lg:flex w-full rounded-b-sm items-center hidden '> 
        <nav className='m-auto w-full h-full flex justify-between items-center content-center'>
          ...
          <ul className='flex justify-center items-center'>
            <li className='hover:text-blue-900 rounded-lg transition-all duration-300 ease-in-out text-white'>
            ...
            <AIChat sizeRobot={36} style='text-white hover:text-blue-900'/>
        </nav>
      </header>
